...
<head>
    ...
    <style>
        body {
            background-image: url('/images/image4.png'); /* Ruta a tu imagen de fondo */
        ...
        .btn-google, .btn-ldap, .btn-direct {
            margin-bottom: 15px; 
            width: 100%;
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="text-center">
                ...
                <a href="{{ route('select-format') }}" class="btn btn-direct btn-lg">Ingresar directamente</a> <!-- Nuevo botón -->
            </div>
        </div>
    </div>
